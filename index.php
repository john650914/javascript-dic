...
<main class="main">
	...
	<p style="height:0px; overflow:hidden;">Javascript是一種物件導向的語言，語法裡的一切幾乎都是以物件的方式操作，有人預言Javascript會是<em>未來唯一的語言</em>。</p>
	<style>
		.test_search{position:relative;}
		.test_search img{position:absolute; left:0; top:0; width:1px; height:1300px; border-right:1px solid red;}
	</style>
